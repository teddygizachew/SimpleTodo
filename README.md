...
* [x] User can **go back to main screen without having to make any changes** from the edit item screen using **back button**
* [x] App is further styled with colors and custom buttons
